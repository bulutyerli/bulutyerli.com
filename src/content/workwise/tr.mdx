...
WorkWise’in backend API dokümantasyonunu yazmak benim için yeni bir deneyimdi. Çok zor değildi ama yine de faydalı bir öğrenme fırsatıydı. Dokümantasyonun ne kadar önemli olduğunu ve başkalarının API’lerle çalışmasını nasıl kolaylaştırdığını öğrendim. Belgelere buradan ulaşabilirsiniz: <a href="https://github.com/bulutyerli/WorkWise-Backend?tab=readme-ov-file#api-documentation" target="_blank">API DOCS</a>
